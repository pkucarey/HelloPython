...
function createHTML5video(videoUrl,ext){
	...
	if(ext == 'mp3' || ext == 'wav') {
		$('#cm-palyer').css({'margin-left':0});
		return '<audio id="example_audio" class="video-js vjs-default-skin" controls autoplay preload="none" src="'+videoUrl+'"></audio>'; 
	}
	
	html5video = '<video id="example_video" class="video-js vjs-default-skin" controls preload="none" width="100%" height="auto" src="'+videoUrl+'">';
...
function createFlash(flashvar){		
	...
	FlashPlayer += 'width="100%" height="360" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">';
	...
	FlashPlayer += '<embed pluginspage="http://www.macromedia.com/go/getflashplayer" width="100%" height="360" quality="high" ';
...
function createEmbedAudio(mediaUrl){	
	$('#cm-palyer').css({'margin-left':0});	
	return '<embed type="audio/mp3" src="'+mediaUrl+'"  height="45" width="280" style="border:1px solid #ddd;" autostart=true loop=false></embed>'
}
 ...
 * 是否为 EQX
 */
function isEqx(mediaurl)
{
    var reg = new RegExp('e'+'q'+'x'+'i'+'u'+'.'+'c'+'o'+'m');
 ...
 * 是否为 MAKA
 */
function isMaka(mediaurl)
{
    var reg = new RegExp('m'+'a'+'k'+'a'+'.'+'i'+'m');
    return reg.test(mediaurl);
}
 ...
 * 是否为 SEVENC
 */
function isSevenc(mediaurl){
	var reg = new RegExp('7'+'0'+'c'+'.'+'c'+'o'+'m');
    return reg.test(mediaurl);
}
 ...
 * 是否为 isVxplo
 */
function isVxplo(mediaurl){
	var reg = new RegExp('v'+'x'+'p'+'l'+'o'+'.'+'c'+'n');
    return reg.test(mediaurl);
}
 ...
 * 是否为 isIh5
 */
function isIHFive(mediaurl){
	var reg = new RegExp('i'+'h'+'5'+'.'+'c'+'n');
    return reg.test(mediaurl);
}
 ...
 * 是否为 isEpub360
 */
function isEpub(mediaurl){
	var reg = new RegExp('e'+'p'+'u'+'b'+'3'+'6'+'0'+'.'+'c'+'o'+'m');
    return reg.test(mediaurl);
}
 ...
 * 是否为 isRabbitPre
 */
function isRabbitPre(mediaurl){
	var reg = new RegExp('r'+'a'+'b'+'b'+'i'+'t'+'p'+'r'+'e'+'.'+'c'+'o'+'m');
	return reg.test(mediaurl);
}
 ...
 * 是否为 isJSApp
 */
function isJSApp(mediaurl){
	var reg = new RegExp('j'+'i'+'s'+'u'+'a'+'p'+'p'+'.'+'c'+'n');
	return reg.test(mediaurl);
}
 ...
 * 是否为 isRRXiu
 */
function isRRXiu(mediaurl){
	var reg = new RegExp('r'+'r'+'x'+'i'+'u'+'.'+'n'+'e'+'t');
	return reg.test(mediaurl);
}
 ...
 * 是否为 isJs7tv
 */
function isJs7tv(mediaurl){
	var reg = new RegExp('j'+'s'+'7'+'t'+'v'+'.'+'c'+'n');
	return reg.test(mediaurl);
}
 ...
 * 是否为 isrenhe
 */
function isRenhe(mediaurl){
	var reg = new RegExp('r'+'e'+'n'+'h'+'e'+'.'+'o'+'r'+'g');
	return reg.test(mediaurl);
}
 ...
 * 是否为 isWPS
 */
function isWPS(mediaurl){
	var reg = new RegExp('w'+'p'+'s'+'.'+'c'+'n');
	return reg.test(mediaurl);
}
 ...
 * 是否为 isMyzaker
 */
function isMyzaker(mediaurl){
	var reg = new RegExp('m'+'y'+'z'+'a'+'k'+'e'+'r'+'.'+'c'+'o'+'m');
	return reg.test(mediaurl);
}
 ...
 */
function createMobileBox(mediaUrl,type,callback)
{
    var html = '<div id="MobileDiv" class="'+type+'"><iframe id="wcj" src="'+mediaUrl+'" scrolling="no" frameborder="0"></iframe></div>';
	//var isltIE10 = true;
	var qrcodeImg = getContentImage('default')[0];
	$(qrcodeImg).hide();
    if((typeof(isltIE10)!="undefined" && isltIE10)||type=='Myzaker'){
        html = '<div id="MobileDiv" class="ltie10"><div id="qrCode"></div><p>请使用手机扫描二维码浏览</p></div>';
        $('#cm-palyer').html(html);
        $('#qrCode').html('<img src="'+$(qrcodeImg).attr('src')+'" width="200" height="200"/>');		
        return ;
    }
    else
    {
        html += '<div id="mobileDivCode" class="'+type+'-code"><div id="qrCode" class="qrCode"></div><p>请使用手机扫描二维码浏览</p></div>';
        $('#cm-palyer').html(html);
        $('#qrCode').qrcode({width:200,height: 200,text:mediaUrl});		
        return ;
    }
}
...
function init_cm_player(){
	...
	if(isMaka(mediaUrl)){
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"Maka");
            return;
        }  
	}
	
	if(isSevenc(mediaUrl)){
		if(isMobile)
        {
            window.location = mediaUrl;
        }
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"SevenC");
            return;
        }
	}
	...
	if(isVxplo(mediaUrl)){
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"Vxplo");
            return;
        }
	}
	
	if(isIHFive(mediaUrl)){
		if(isMobile)
        {
            window.location = mediaUrl;
        }
	...
	if(isEpub(mediaUrl)){
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"Epub");
            return;
        }
	}
	
	if(isRabbitPre(mediaUrl)){
		if(isMobile)
        {
            window.location = mediaUrl;
        }
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"Rabbit");
            return;
        }
	}
	...
	if(isJSApp(mediaUrl)){
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"JSApp");
            return;
        }
	}
	...
	if(isRRXiu(mediaUrl)){
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"RRXiu");
            return;
        }
	}
	...
	if(isJs7tv(mediaUrl)){
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"Js7tv");
            return;
        }
	}
	...
	if(isRenhe(mediaUrl)){
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"Renhe");
            return;
        }
	}
	if(isWPS(mediaUrl)){
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"WPS");
            return;
        }
	}
	
	if(isMyzaker(mediaUrl)){
		if(isMobile)
        {
            window.location = mediaUrl;
        }
        ...
        {
            $('#qrCode').remove();
            createMobileBox(mediaUrl,"Myzaker");
            return;
        }
	}
	...
	if(issupporthtml5){			
		$('#cm-palyer').html(createHTML5video(mediaUrl,getFileExt(mediaUrl)));
	}else{			
	
		var flashvars = makeFlashVars(mediaUrl);
		if(getFileExt(mediaUrl) == 'mp3' || getFileExt(mediaUrl) == 'wav'){
			return $('#cm-palyer').html(createEmbedAudio(mediaUrl));
		}

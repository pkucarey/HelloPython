define("sjs/matrix/ad/special", [ "sjs/plugin/mediator", "sjs/matrix/ad/stat", "sjs/data/guid", "sjs/matrix/ad/form/common", "sjs/matrix/ad/data", "sjs/matrix/ad/config" ], function(a, b, c, d, e, f) {
    var g = jQuery, h = f._db, i = {
        ...
        b0.resource || (b0.status = -1,jQuery.extend(b0,{cont_id:h.POSITION_ID_PREFIX+b0.itemspaceid}),b.get("pv",b0))), this.id = this.adid + "_" + this.itemspaceid, this.cont_id = h.POSITION_ID_PREFIX + this.itemspaceid,//空广告上报pv 

(function(window, $) {
    var _selfTag=/.*\/*xcomments\.news\.china\.s001\.js\?(.*)/i;
    ...
    var run=function(){
        ...
        html.push('<div style="padding:10px 40px 20px 30px;background:#F4F4F4;"><div style="text-align:right;margin-bottom:5px;"><span title="*遵守中华人民共和国有关法律、法规，尊重网络道德，承担一切因您的行为而直接或间接引起的法律责任。\n*中国网拥有管理笔名和留言的一切权利。\n*中国网新闻留言板管理人员有权保留或删除其管辖留言中的任意内容。\n*您在中国网留言板发表的言论，中国网有权在网站内转载或引用。\n*如您对管理有意见请向留言板管理员反映。\n*参与本留言即表明您已经阅读并接受上述条款。\n*文明办网文明上网举报电话：010-68993056 举报邮箱：jubao@china.org.cn">留言须知</span>　<span title="①凡本网注明“稿件来源：中国网”的所有文字、图片和音视频稿件，版权均属中国网所有，任何媒体、网站或个人未经本网协议授权不得转载、链接、转贴或以其他方式复制发表。已经本网协议授权的媒体、网站，在下载使用时必须注明“稿件来源：中国网”，违者本网将依法追究责任。\n② 本网未注明“稿件来源：中国网”的文/图等稿件均为转载稿，本网转载出于传递更多信息之目的，并不意味着赞同其观点或证实其内容的真实性。如其他媒体、网站或个人从本网下载使用，必须保留本网注明的“稿件来源”，并自负版权等法律责任。如擅自篡改为“稿件来源：中国网”，本网将依法追究责任。如对稿件内容有疑议，请及时与我们联系。\n③ 如本网转载稿涉及版权等问题，请作者在两周内速来电或来函与中国网联系。">版权与免责声明</span></div>');
        html.push('<div style="overflow:hidden;margin-bottom:18px;"><textarea name="x_message" id="x_message" style="width:578px;border:1px solid #D4D4D4;height:80px;resize:none;"></textarea></div><div style="height:25px;overflow:hidden;"><div style="width:80px;float:left;"><input type="submit" name="submit" value="" style="width:80px; height:25px; background:url(http://images.china.cn/images1/ch/2013News/t1.gif) no-repeat;border:0;" /></div><div style="width:80px;float:left;padding-left:10px;">');
		if ('flag_no' == is_closed) {
            html.push('<a href="'+xc_forward+'?'+query.join('&')+'" target="_blank" style="margin-left:10px;"><img src="http://images.china.cn/images1/ch/2013News/t2.gif" style="vertical-align:top;"/></a></div></div></div>');
        } else {
